  ...
  if(nrow(tmpdat) > 0){
    for(i in 1:nrow(tmpdat)){
      ...
      if(nrow(duprow) > 0) {
        ...
        #Insert data
        sqlQuery(channel, paste0("INSERT INTO Samples (Sample_ID,Sample_ID_2,Site_ID,Type,Start_Date,Start_Time,Collection_Date,Collection_Time,Sample_Volume_ml,Collector_type,Phase,Depth_meters,Sample_Source,Sample_Ignore,Sample_Comments,Project_ID) VALUES ",
                                 dat))
      }
    }
  }
